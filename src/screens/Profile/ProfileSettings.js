            ...
            try {
                ...
                if (response.data) {
                    if (response.data.update_fotoprofile_v2.code !== 200) {
                        throw new Error(
                            response.data.update_fotoprofile_v2.message
                        );
                    }
                    // Alert.alert(t('success'));

                    let Xsetting = { ...seting.current };
                    Xsetting.user["picture"] =
                        response.data.update_fotoprofile_v2.path;
                    await AsyncStorage.setItem(
                        "setting",
                        JSON.stringify(Xsetting)
                    );
                ...
                <View style={{ width: "45%" }}>
                    ...
                    >
                        ...
                        <Input
                            ...
                            onChangeText={(text) =>
                                _handleOnChange(text, "first_name")
                            }
                ...
                <View style={{ width: "45%" }}>
                    ...
                    >
                        ...
                        <Input
                            ...
                            onChangeText={(text) =>
                                _handleOnChange(text, "last_name")
                            }
                            keyboardType="default"
                        />
                    </Item>
