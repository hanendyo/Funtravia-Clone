...
export default function EventDetail(props) {
	...
	let [dataevent, setDataEvent] = useState(props.navigation.getParam('data'));
	...
	let [dataTiket, setDataTiket] = useState(
		props.navigation.getParam('data').ticket,
	);
