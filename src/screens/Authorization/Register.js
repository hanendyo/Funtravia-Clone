              ...
              <View
                ...
                <View style={{flexDirection: 'row'}}>
                  <CustomImage
                    source={logo_google}
                    isTouchable
                    onPress={() => externalRegister('RegisterGoogle')}
                    customStyle={{
                      marginHorizontal: 15,
                      width: 50,
                      height: 50,
                  ...
                  <CustomImage
                    ...
                    isTouchable
                    onPress={() => externalRegister('RegisterFacebook')}
                    customStyle={{
                      marginHorizontal: 15,
                      width: 50,
                      height: 50,
                  ...
                  {/* <PhoneLingkaran
									...
									onPress={() => externalRegister('RegisterPhone')}
									height={40}
									width={40}
								/> */}
                </View>
