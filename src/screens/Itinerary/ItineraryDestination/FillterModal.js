...
import { Bottom, Search, Xhitam } from "../../../assets/svg";
...
export default function FilterModal({
  ...
  let [dataFilterCategoris, setFilterCategoris] = useState(datasfilter);
  ...
  console.log("filterCountries filter modal", dataFilterCategori);
