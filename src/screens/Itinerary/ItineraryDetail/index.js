...
export default function ItineraryDetail(props) {
            ...
            try {
                ...
                if (response.data) {
                    if (response.data.update_cover_itinerary.code !== 200) {
                        throw new Error(
                            response.data.update_cover_itinerary.message
                        );
                    }
    ...
    const [
        mutationDeleteDay,
        {
            loading: Loadingdeleteday,
            data: datadeleteDay,
            error: errordeleteday,
        },
    ...
    const setTime = async (timeselected, nn) => {
        ...
        if (positiondate == "start") {
            ...
            if (datas[parseFloat(indexinput) - 1]) {
                ...
                let timestartsebelum = datas[
                    parseFloat(indexinput) - 1
                ].time.split(":");
                ...
                if (inde !== -1) {
                    ...
                    if ((x = Xdata.length)) {
                        try {
                            ...
                            if (response.data) {
                                if (
                                    response.data.update_timeline.code !== 200
                                ) {
                                    throw new Error(
        ...
        try {
            ...
            if (response.data) {
                if (
                    ...
                    throw new Error(
                        response.data.unsetItineraryFavorit.message
                    );
                }
            }
        } catch (error) {
                ...
                >
                    {datadetail && datadetail.itinerary_detail ? (
                        ...
                        >
                            ...
                            >
                                {datadetail.itinerary_detail.buddy.map(
                                    (value, i) => {
                                        if (i < 4) {
                                            return (
                                                <View key={i}>
                    ...
                    >
                        ...
                        >
                            ...
                            dataList[index].latitude ==
                                dataList[index - 1].latitude &&
                            dataList[index].longitude ==
                                dataList[index - 1].longitude ? (
                                <View
                                    style={{
                                        width: 10,
                                        height: 10,
            ...
            >
                    ...
                    >
                        ...
                        >
                            <Text style={{ color: "#d75995" }}>
                                {t("delete")} {t("day")} {datadayaktif.day}{" "}
                                {t("from")} {t("Itinerary")}
                            </Text>
                        </TouchableOpacity>
                    </View>
                                ...
                                if (jam < 24) {
                                    if (jam < 23) {
                                        props.navigation.push("ItinGoogle", {
                                            ...
                                            datadayaktif: datadayaktif,
                                            lat:
                                                datadetail.itinerary_detail.city
                                                    .latitude,
                                            long:
                                                datadetail.itinerary_detail.city
                                                    .longitude,
                ...
                >
                    ...
                    >
                        ...
                        <TouchableOpacity
                            onPress={() =>
                                setTime(jamer + ":" + menor + ":00", dataList)
                            }
                            style={{
                                marginTop: 20,
                                backgroundColor: "#209fae",
