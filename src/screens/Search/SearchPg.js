...
export default function SearchPg(props, { navigation, route }) {
    ...
    console.log("krimiman", props.route.params.aktifsearch);
    console.log("statusaktif", aktifsearch);
    ...
    const _unfollow = async (id, index) => {
        if (token || token !== "") {
            user_search[index].status_following = false;
            try {
                ...
                refetchSrcuser();
                Alert.alert("" + error);
                user_search[index].status_following = true;
            }
        } else {
            Alert.alert("Please Login");
        }
            ...
            try {
                ...
                if (response.data) {
                    if (
                        ...
                        Toast.show({
                            text: "Failed To Follow This User!",
                            position: "bottom",
                            buttonText: "Okay",
                            duration: 3000,
                        });
