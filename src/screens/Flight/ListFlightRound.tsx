...
export default function ListFlightRound(props) {
	...
	const filterdata = (datef) => {
		var datereq = DataRequest.return.fulldate.toISOString().split('T');
					...
					{dataFlight && dataFlight.length > 0
						? dataFlight.map((data, index) => {
								...
								return (
									<TouchableOpacity
										onPress={() => {
											props.navigation.navigate('Flightdetailround', {
												data: data,
												kamus: Datas,
												request: DataRequest,
												token: token,
				...
				<View
					...
					<View style={{ paddingBottom: 40 }}>
						<TouchableOpacity
							...
							<Text style={{ fontFamily: 'lato-reg', fontSize: 14 }}>
								Low to High Price
							</Text>
			...
			<Modal
				...
				<View
					...
					<View
						...
						<TouchableOpacity
							onPress={() => setmodalfiltershow(false)}
							style={{
								flexDirection: 'row',
								alignItems: 'center',
								alignContent: 'center',
...
ListFlightRound.navigationOptions = (props) => ({
	// headerTransparent: true,
	headerTitle: 'Search Result Return',
	headerMode: 'screen',
	headerStyle: {
		backgroundColor: '#209FAE',
		elevation: 0,
