...
import { Arrowbackwhite, Arrowbackios, Xgray } from "../../assets/svg";
...
import album from "../../graphQL/Query/Feed/AlbumDetailItinerary";
...
export default function AlbumDetailItinerary(props) {
  ...
  const [
    ...
    onCompleted: () => {
      setdata(dataalbum?.detail_assets_album_itinerary);
    },
  });

  const [mutationRenameAlbum] = useMutation(RenameAlbumTitle, {
    context: {
      headers: {
        "Content-Type": "application/json",
        Authorization: token,
