...
export default function FeedList({ props, isPost }) {
    console.log("SCREEN LIST FEED", props.route.params);
                    ...
                    try {
                        ...
                        if (response.data) {
                            if (
                                ...
                                throw new Error(
                                    response.data.like_post.message
                                );
                            }
                        }
                    } catch (error) {
                    ...
                    try {
                        ...
                        if (response.data) {
                            if (
                                ...
                                throw new Error(
                                    response.data.unlike_post.message
                                );
                            }
              ...
              {t("blockUser")}
                            ...
                            datasFollow.findIndex(
                                ...
                                <TouchableOpacity
                                    ...
                                    onPress={() =>
                                        _follow(selectedOption.user.id)
                                    }
                                >
                                    <Text
                                        size="description"
                                ...
                                <TouchableOpacity
                                    ...
                                    onPress={() =>
                                        _unfollow(selectedOption.user.id)
                                    }
                                >
                                    <Text
                                        size="description"
