            ...
            >
                ...
                >
                    ...
                    datasFollow.findIndex(
                        (k) => k["id"] == dataPost?.current.user?.id
                    ) == -1 ? (
                        <TouchableOpacity
                            style={{
                                paddingVertical: 10,
                ...
                {dataPost.current.user.first_name ? dataPost.current.user.last_name : null}
                            ...
                            dataPost.current.itinerary !== null ? (
                                <View>
                                    <Pressable
                                        onPress={() =>
                                            goToItinerary(dataPost.current)
                                        }
                                        style={{
                                            flexDirection: "row",
                                            marginBottom: 10,
            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        <Pressable
                            onPress={() =>
                                comment(dataPost.current.id, statusText)
                            }
                            style={{
                                flex: 1,
                                // borderWidth: 1,
