...
export default function Feed(props) {
  ...
  if (dataPost && dataPost && "datas" in dataPost.feed_search_bytag_paging) {
    feed_search_bytag_paging = dataPost.feed_search_bytag_paging.datas;
  }
  ...
  const handleOnEndReached = () => {
    console.log(dataPost.feed_search_bytag_paging.page_info.hasNextPage);
              ...
              >
                <View style={{}}>
                    ...
                    onPress={
                      () =>
                        props.navigation.navigate("FeedStack", {
                          screen: "CommentsById",
                          params: {
                            post_id: feed_search_bytag_paging[index - 8].id,
                          },
                        })
                      // teststate(index-8)
                    }
                  ...
                  >
                    <Image
                      source={{
                        uri:
                          feed_search_bytag_paging[index - 8].assets[0]
                            .filepath,
                      }}
                      style={{
                        height: width / 3 - 10,
                  ...
                  <Pressable
                    onPress={() =>
                      props.navigation.navigate("FeedStack", {
                        screen: "CommentsById",
                        params: {
                          post_id: feed_search_bytag_paging[index - 7].id,
                        },
                      })
                    }
                    style={
                  ...
                  >
                    <Image
                      source={{
                        uri:
                          feed_search_bytag_paging[index - 7].assets[0]
                            .filepath,
                      }}
                      style={{
                        height: width / 3 - 10,
                ...
                <Pressable
                  onPress={() =>
                    props.navigation.navigate("FeedStack", {
                      screen: "CommentsById",
                      params: {
                        post_id: feed_search_bytag_paging[index - 6].id,
                      },
                    })
                  }
                  style={
                ...
                >
                  <Image
                    source={{
                      uri:
                        feed_search_bytag_paging[index - 6].assets[0].filepath,
                    }}
                    style={{
                      height: (width + width) / 3 - 15,
                      width: (width + width) / 3 - 20,
              ...
              >
                <Pressable
                  onPress={() =>
                    props.navigation.navigate("FeedStack", {
                      screen: "CommentsById",
                      params: {
                        post_id: feed_search_bytag_paging[index - 5].id,
                      },
                    })
                  }
                  style={
                ...
                >
                  <Image
                    source={{
                      uri:
                        feed_search_bytag_paging[index - 5].assets[0].filepath,
                    }}
                    style={{
                      height: (width + width) / 3 - 15,
                      width: (width + width) / 3 - 20,
                ...
                <View style={{}}>
                  <Pressable
                    onPress={() =>
                      props.navigation.navigate("FeedStack", {
                        screen: "CommentsById",
                        params: {
                          post_id: feed_search_bytag_paging[index - 4].id,
                        },
                      })
                    }
                    style={
                  ...
                  >
                    <Image
                      source={{
                        uri:
                          feed_search_bytag_paging[index - 4].assets[0]
                            .filepath,
                      }}
                      style={{
                        height: width / 3 - 10,
                  ...
                  <Pressable
                    onPress={() =>
                      props.navigation.navigate("FeedStack", {
                        screen: "CommentsById",
                        params: {
                          post_id: feed_search_bytag_paging[index - 3].id,
                        },
                      })
                    }
                    style={
                  ...
                  >
                    <Image
                      source={{
                        uri:
                          feed_search_bytag_paging[index - 3].assets[0]
                            .filepath,
                      }}
                      style={{
                        height: width / 3 - 10,
              ...
              >
                <Pressable
                  onPress={() =>
                    props.navigation.navigate("FeedStack", {
                      screen: "CommentsById",
                      params: {
                        post_id: feed_search_bytag_paging[index - 2].id,
                      },
                    })
                  }
                  style={
                ...
                >
                  <Image
                    source={{
                      uri:
                        feed_search_bytag_paging[index - 2].assets[0].filepath,
                    }}
                    style={{
                      height: width / 3 - 10,
                      width: width / 3 - 10,
                ...
                <Pressable
                  onPress={() =>
                    props.navigation.navigate("FeedStack", {
                      screen: "CommentsById",
                      params: {
                        post_id: feed_search_bytag_paging[index - 1].id,
                      },
                    })
                  }
                  style={
                ...
                >
                  <Image
                    source={{
                      uri:
                        feed_search_bytag_paging[index - 1].assets[0].filepath,
                    }}
                    style={{
                      height: width / 3 - 10,
                      width: width / 3 - 10,
                ...
                >
                  <Image
                    source={{
                      uri: feed_search_bytag_paging[index].assets[0].filepath,
                    }}
                    style={{
                      height: width / 3 - 10,
                      width: width / 3 - 10,
