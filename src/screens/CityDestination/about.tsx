...
export default function about(props) {
	...
	useEffect(() => {
		if (props.navigation.getParam('active')) {
			setActives(props.navigation.getParam('active'));
		}
	}, []);
					...
					<Ripple
						...
						<Text
							...
							style={{
								...
								borderBottomColor: actives == 'whentogo' ? '#14646E' : '#DAF0F2',
					...
					<Ripple
						...
						<Text
							...
							style={{
								...
								borderBottomColor: actives == 'localfood' ? '#14646E' : '#DAF0F2',
								paddingVertical: 15,
					...
					<Ripple
						...
						<Text
							...
							style={{
								...
								borderBottomColor: actives == 'souvenir' ? '#14646E' : '#DAF0F2',
								paddingVertical: 15,
