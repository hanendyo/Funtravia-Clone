            ...
            try {
                ...
                if (response.data) {
                    if (
                        ...
                        throw new Error(
                            response.data.setItineraryFavorit.message
                        );
                    }
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    {tutup == true &&
                                    render.destination_type.length > 7 ? (
                                        <TouchableOpacity
                                            onPress={() => {
                                                setTutup(false);
                                            }}
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                <RenderMaps
                                    icon={
                                        render.map ? render.map : "mn-indonesia"
                                    }
                                    height={250}
                                    width={width - 70}
                                    style={{
                                    ...
                                    >
                                        <View
                                            style={{
                                                ...
                                                shadowOpacity:
                                                    arrayShadow.shadowOpacity,
                                                shadowRadius:
                                                    arrayShadow.shadowRadius,
                                                elevation:
                                                    arrayShadow.elevation,
                                                borderWidth: 0,
                                                width: "95%",
                                                justifyContent: "space-between",
