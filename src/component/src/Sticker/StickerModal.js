...
export default function StickerModal({ submitSticker }) {
    console.log("sss");
    // console.log("key", KeyboardRegistry.setItem("test"));
                    ...
                    {tabData.map((data, index) => {
                        return (
                            <Tab.Screen
                                ...
                                component={() => (
                                    <StickerScreen
                                        submitSticker={(e) => submitSticker(e)}
                                    />
                                )}
                                options={{
...
// KeyboardRegistry.registerKeyboard("unicorn.StikerKeyboard", () => StickerModal);
